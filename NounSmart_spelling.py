...
st.markdown("Practice the plural forms of words from unit 1 and 2. There are 16 items in total. Try to get all the answers correct. Enter your nickname to start.")
